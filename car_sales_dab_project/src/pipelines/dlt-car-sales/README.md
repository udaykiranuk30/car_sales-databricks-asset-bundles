...
This folder defines all source code for the 'dlt-car-sales' pipeline:
...
* Take a look at the sample under "sample_users_dlt_car_sales.py" to get familiar with the syntax.
