# car_sales_dab_project

The 'car_sales_dab_project' project was generated by using the default template.

* `src/`: Python source code for this project.
  * `src/car_sales_dab_project/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] car_sales_dab_project_etl` to your workspace.
